...
twentyfour_mood <- ggplot(dataBFE,aes(x=hour2,y=mood))+ggtitle('24-Hour Model')+geom_smooth()+geom_line(aes(x=hour2,y=CircFit+mean(mood)),col='darkgreen')+labs(x='Time of day (hours)', y='Mood')
```
...
ggplot(dataBFE,aes(x=hour2,y=fresh))+geom_smooth()+geom_line(aes(x=hour2,y=freshCircFit12),col='darkgreen')+labs(x='Time of day (hours)', y='Tired/Fresh')
```
...
twelve_mood <- ggplot(dataBFE,aes(x=hour2,y=mood))+ggtitle('12-Hour Model')+geom_smooth()+geom_line(aes(x=hour2,y=CircFit12),col='darkgreen')+labs(x='Time of day (hours)', y='Mood')
```
...
combined_mood <- ggplot(dataBFE,aes(x=hour2,y=mood))+ggtitle('Combined Model')+geom_smooth()+geom_line(aes(x=hour2,y=CircFitBoth),col='darkgreen')+labs(x='Time of day (hours)', y='Mood')
```
#### HeartRate
```{r}
# Freshness: Simple oscillation model
...
```{r}
grid.arrange(twentyfour_mood, twelve_mood, combined_mood)
